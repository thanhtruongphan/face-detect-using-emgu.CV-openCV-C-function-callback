...
// using System.Drawing; // Đảm bảo sử dụng System.Drawing.Common
// using Emgu.CV;
...
//         string imagePath = "face.jpg"; // Đường dẫn tới ảnh đầu vào

//         // Tải ảnh đầu vào
//         Mat inputImage = CvInvoke.Imread(imagePath, Emgu.CV.CvEnum.ImreadModes.Color);
//         if (inputImage.IsEmpty)
//         {
//             Console.WriteLine("Không thể tải ảnh!");
//             return;
//         }
...
//         // Tạo blob từ ảnh
//         var inputBlob = DnnInvoke.BlobFromImage(inputImage, 1.0, new System.Drawing.Size(300, 300), new MCvScalar(104, 177, 123), false, false);
...
//         // Xử lý kết quả
//         Rectangle[] faces = ProcessOutput(output, inputImage.Width, inputImage.Height);

//         // In kết quả
//         Console.WriteLine("Số khuôn mặt phát hiện được: " + faces.Length);
//         foreach (var face in faces)
//         {
//             Console.WriteLine($"Khuôn mặt tại: {face}");
//         }
//     }

//     private static Rectangle[] ProcessOutput(Mat output, int imageWidth, int imageHeight)
//     {
